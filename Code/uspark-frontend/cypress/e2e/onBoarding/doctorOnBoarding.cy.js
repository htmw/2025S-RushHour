describe("Doctor Onboarding Flow", () => {
  ...
  it("should signup a new user and complete doctor onboarding", () => {
    ...
    cy.wait(2000);
    cy.get("[data-cy=select-hospital]").type("Other{enter}");
    cy.get("[data-cy=hospital-address-input]").type("123 Test Lane");

    // Upload a verification document
    const filePath = "cypress/fixtures/test-verification.pdf";
