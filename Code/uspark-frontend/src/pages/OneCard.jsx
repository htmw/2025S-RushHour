...
const OneCard = () => {
  ...
  const [storedPin, setStoredPin] = useState(localStorage.getItem("userPin") || "");
  ...
  return (
      <div className={`background-container ${showCard ? "blurred" : ""}`}>
        <motion.div className="One-Content"> {/* Added one-card-content class */}
          {!storedPin && (
            <Card className="patient-card">
              <CardContent>
                ...
                <TextField
                  ...
                  margin="normal"
                />
                <Button variant="contained" color="primary" onClick={handlePinSetup}>
                  Set PIN
                </Button>
              </CardContent>
            </Card>
          ...
          {storedPin && !showCard && (
            <Card className="patient-card" component={motion.div} whileHover={{ scale: 1.05 }}>
              <CardContent>
                ...
                <TextField
                  ...
                  margin="normal"
                />
                <Button variant="contained" color="primary" onClick={handlePinSubmit}>
                  Unlock
                </Button>
              </CardContent>
            </Card>
          ...
          {showCard && (
            ...
            >
              ...
              <InsuranceCard/>
                ...
                <Button variant="contained" color="secondary" onClick={() => setShowCard(false)}>
                  Close
                </Button>
            </motion.div>
          )}
